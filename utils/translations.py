...
TRANSLATIONS = {
    ...
    "load_dataset": {
        ...
        "dbms_success_upload": {"en": "Database **{db_name}** successfully uploaded to **{dbms_name}** DBMS.", "it": "Database {db_name} caricato con successo su {dbms_name} DBMS."},
        "dbms_success_download": {"en": "Database **{db_name}** successfully downloaded to **{dbms_name}** DBMS.", "it": "Database {db_name} scaricato con successo su {dbms_name} DBMS."},
    ...
    "profiling": {
        ...
        "heatmap_types": {"en": "Heatmap", "it": "Heatmap"},
...
"llm_adapters": {
    ...
    "charts": {
        "resource_usage": {"en": "Resource Usage (%)", "it": "Utilizzo Risorse (%)"},
        "time": {"en": "Time", "it": "Tempo"},
        "usage_pct": {"en": "Usage (%)", "it": "Utilizzo (%)"},
        "cpu_usage": {"en": "CPU Usage (%)", "it": "Utilizzo CPU (%)"},
        "gpu_usage": {"en": "GPU Usage (%)", "it": "Utilizzo GPU (%)"},
        "power_consumption": {"en": "Power Consumption (W)", "it": "Consumo Energetico (W)"},
        "power_w": {"en": "Power (W)", "it": "Potenza (W)"},
        "cpu_power": {"en": "CPU Power (W)", "it": "Potenza CPU (W)"},
        "gpu_power": {"en": "GPU Power (W)", "it": "Potenza GPU (W)"},
        "instant_co2": {"en": "Instant CO₂ Emissions (g/s)", "it": "Emissioni CO₂ Istantanee (g/s)"},
        "emissions_gs": {"en": "Emissions (g/s)", "it": "Emissioni (g/s)"},
        "co2_cpu": {"en": "CO₂ CPU (g/s)", "it": "CO₂ CPU (g/s)"},
        "co2_gpu": {"en": "CO₂ GPU (g/s)", "it": "CO₂ GPU (g/s)"},
        "cumulative_co2": {"en": "Cumulative CO₂ (g)", "it": "CO₂ Cumulativa (g)"},
        "total_co2_phase": {"en": "Total CO₂ Emissions by Phase", "it": "Emissioni Totali CO₂ per Fase"},
        "phase": {"en": "Phase", "it": "Fase"},
        "total_co2_g": {"en": "Total CO₂ (g)", "it": "CO₂ Totale (g)"}
    },
}
